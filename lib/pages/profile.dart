...
class _ProfileState extends State<Profile> {
  ...
  buildProfileButton() {
    //viewing our own profile we'll show edit profile
    ...
    if(isProfileOwner) {
      ...
      return buildButton(
        ...
        //changes to do in buildbutton for the function handlefollowuser
      );
    }
    else if(!isFollowing) {
      return buildButton(
        ...
        //changes to do in buildbutton for the function handleunfollowuser
      );
    }
  }
  ...
  handleUnfollowUser() async {
    ...
    //remove follower
    await followersRef.document(widget.profileId).collection('userFollowers')
    ...
    //remove following
    await followingRef.document(currentUserId).collection('userFollowing')
    ...
    await activityFeedRef.document(widget.profileId).collection('feedItems')
    .document(currentUserId).get().then((doc) {
      if(doc.exists) {
        doc.reference.delete();
      }
  ...
  handleFollowUser() async {
    ...
    //put that user on your following collection and update your following collection linked to your id
    await followingRef.document(currentUserId).collection('userFollowing')
