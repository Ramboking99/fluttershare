...
class Post extends StatefulWidget {
  ...
  Post({Key key, this.postId, this.ownerId, this.username, this.location, this.description, this.mediaUrl, this.likes}) : super(key: key);
...
class _PostState extends State<Post> {
  ...
  _PostState({Key key, this.postId, this.ownerId, this.username, this.location, this.description, this.mediaUrl, this.likes, this.likeCount});
